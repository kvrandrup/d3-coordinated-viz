//*main script for GEOG 575 Lab 2* *Kristina Randrup 2021*//

(function(){

//pseudo-global variables
var attrArray = ["2016total", "2012total", "2008total", "2004total", "2000total"]; //list of attributes
...
function joinData(selectedCountries, csvData){        //variables for data join
    var attrArray = ["2016total", "2012total", "2008total", "2004total", "2000total"];

    //loop through csv to assign each set of csv attribute values to geojson region
    for (var i=0; i<csvData.length; i++){
        var csvName = csvData[i]; //the current country
        var csvKey = csvName.NAME; //the CSV primary key

        //loop through geojson regions to find correct region
        for (var a=0; a<selectedCountries.length; a++){

            var geojsonProps = selectedCountries[a].properties; //the current country geojson properties
            ...
            if (geojsonKey == csvKey){
                ...
                attrArray.forEach(function(attr){
                    var val = parseFloat(csvName[attr]); //get csv attribute value
